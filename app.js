    ...
    container.innerHTML = workoutDays.map((day, index) => `
        <div class="workout-item-wrapper">
            <div class="workout-day-card ${editDaysMode ? 'edit-mode' : ''}" onclick="${editDaysMode ? '' : `openWorkoutDay('${day.id}')`}">
                ...
                ${editDaysMode ? `
                    <button class="day-delete-button" onclick="event.stopPropagation(); showDayEditMenu('${day.id}')">🗑️</button>
                ` : ''}
            </div>
            ${editDaysMode ? `
    ...
    container.innerHTML = exercises.map((exercise, index) => `
        <div class="workout-item-wrapper">
            <div class="exercise-card ${editExercisesMode ? 'edit-mode' : ''}">
                ...
                ${editExercisesMode ? `
                    <button class="exercise-edit-button" onclick="openEditExerciseModal(${index})">✏️</button>
                ` : ''}
            </div>
            ${editExercisesMode ? `
                <div class="move-controls">
